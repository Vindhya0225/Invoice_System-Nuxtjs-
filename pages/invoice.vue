...
<!-- Payment Status Section -->
    ...
    <div class="payment-options-section" v-if="selectedStatus === 'pending' || selectedStatus === 'overdue'">
...
export default {
  ...
  methods: {
    ...
    const invoice = {
      ...
      dueDate: this.dueDate,
      createdAt: new Date() // Add a timestamp for the invoice
    };

    // Commit invoice to Vuex
    this.$store.commit('addInvoice', invoice);
